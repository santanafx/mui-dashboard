...
import { addFood } from '../../../Services/CardTable/CardTable.service';
import {
  FoodModalProps,
  NutritionModalProps,
} from './AddNutritionModal.interface';
import {
  DivButtons,
  DivForm,
  DivFormButtons,
...
export const AddNutritionModal = ({ open, setOpen }: NutritionModalProps) => {
